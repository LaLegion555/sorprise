    ...
    update: function () {
      ...
      if (this.playing) {
        ...
        if (!collision) {
          ...
          popup.innerHTML = `
    <h1>Muy bien!!<br>Lo hizo perfecto <3<br> recuerde que hay una sorpresa más :3</h1>&nbsp&nbsp&nbsp&nbsp
    <img class="t" src="assests/images/grinch-gif-5.gif" alt="" width="210px" height="150px">
    <a href="public_html/QUIERES.html" class="close">Hay una sopresa más!, descubrelo</a>
</a>
    `;
          document.body.appendChild(popup);
          // Agregar la clase "active" al popup para mostrarlo
